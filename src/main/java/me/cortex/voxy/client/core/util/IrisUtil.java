...
public class IrisUtil {
    ...
    // FogParameters was removed in Sodium 0.6.x — record no longer carries fog state
    ...
    // NeoForge: replaced FabricLoader with ModList; mod ID is "iris" for official Iris NeoForge port
